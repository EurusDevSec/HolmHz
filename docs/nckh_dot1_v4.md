...
3.8.2 Luồng xử lý request	25
3.8.3 CI/CD Pipeline	26
3.8.4 Tối ưu chi phí (Cost Optimization)	26
CHƯƠNG 4. KẾT QUẢ THỰC NGHIỆM VÀ ĐÁNH GIÁ	27
4.1 Môi trường và tham số thực nghiệm	27
4.2 Bộ dữ liệu	28
4.3 Kết quả huấn luyện 4 mô hình HolmHz	29
4.4 Benchmark tổng hợp 7 mô hình	30
4.5 Phân tích biểu đồ	31
4.5.1 Biểu đồ cột — ID AUC vs OOD AUC	32
4.5.2 Biểu đồ Radar — Đa chỉ số	33
4.5.3 Heatmap OOD per-source	33
4.6 Phân tích mô hình EfficientNet-B0 — Tại sao mô hình nhỏ nhất lại tốt nhất?	35
4.7 Phân tích sự thất bại của Swin-Tiny	36
4.8 So sánh với các nghiên cứu baseline	36
4.9 Đánh giá KPI đề tài	37
4.10 Web Demo	38
4.11 Phân tích Grad-CAM: Từ minh họa đến giải thích	38
...
Bảng 4.3: Chi tiết nguồn dữ liệu trong bộ dữ liệu v2	28
Bảng 4.4: Kết quả huấn luyện 4 mô hình HolmHz trên Dataset v2	30
Bảng 4.5: Benchmark tổng hợp 7 mô hình (ID và OOD)	31
Bảng 4.6: Độ chính xác OOD theo nguồn dữ liệu	34
Bảng 4.7: Đánh giá KPI đề tài	37
Bảng 4.8: Đánh giá KPI theo từng mô hình	38
...
Hình 3.2: Kiến trúc triển khai đám mây HolmHz trên AWS	24
Hình 4.1: Biểu đồ cột – ID AUC và OOD AUC	32
Hình 4.2: Biểu đồ Radar – Đa chỉ số	33
Hình 4.3: Heatmap OOD per-source	34
...
2.	Huấn luyện và so sánh 4 kiến trúc học sâu: EfficientNet-B0, ResNet-18 (nhóm CNN chính), ViT-Small/16 và Swin-Tiny (nhóm Transformer, đưa vào với mục đích đối chứng) — sử dụng Transfer Learning từ ImageNet.
...
STT	Nguồn	Nội dung	Loại generator	Số lượng
...
Ours	ViT-Small/16 (đối chứng)	ViT-Small/16	22M	0.974	0.921	0.920	0.833	0.747	Có
Ours	Swin-Tiny† (đối chứng)	Swin-T	28M	0.620	0.537	0.633	0.811*	0.676	Có
...
Nguồn	Nền tảng	Tên dataset trên Kaggle	Kaggle Slug	Giấy phép
...
DeepDetect-2025	Kaggle	DeepDetect-2025 (Ayushman)	https://www.kaggle.com/datasets/ayushman/deepdetect-2025	Apache 2.0
Diffusion Fakes	Kaggle	Labeled Deepfake Image Collection (Jayanth Bottu)	https://www.kaggle.com/datasets/jayanthbottu/labeled-deepfake-image-collection	CC BY 4.0
CIPLab Faces	Kaggle	Real and Fake Face Detection (CIPLAB @ Yonsei University)	https://www.kaggle.com/datasets/ciplab/real-and-fake-face-detection	CC BY-NC-SA 4.0
Camera vs AI	Kaggle	Camera Photos vs Ai generated Photos Classifier (Rafsun Ahmad)	https://www.kaggle.com/datasets/rafsunahmad/camera-photos-vs-ai-generated-photos-classifier	Cần kiểm tra
